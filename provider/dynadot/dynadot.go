...
// DynadotClient представляет клиента для API Dynadot
type DynadotClient struct {
	httpClient *http.Client
	apiKey     string
}

// NewDynadotClient создает нового клиента для API Dynadot
...
// DynadotRecord представляет DNS-запись в Dynadot
...
// DynadotProvider представляет провайдера для Dynadot
...
// NewDynadotProvider инициализирует нового провайдера Dynadot
...
// Records возвращает список записей для всех соответствующих зон
...
// ApplyChanges применяет изменения в данных DNS
